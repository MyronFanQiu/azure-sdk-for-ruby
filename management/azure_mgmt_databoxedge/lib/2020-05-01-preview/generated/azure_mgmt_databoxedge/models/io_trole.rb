...
module Azure::DataBoxEdge::Mgmt::V2020_05_01_preview
  module Models
    ...
    class IoTRole < Role
      ...
      # @return [IoTEdgeAgentInfo] Iot edge agent details to download the agent
      # and bootstrap iot runtime.
      attr_accessor :io_tedge_agent_info

      # @return [HostPlatformType] Platform where the Iot runtime is hosted.
      # Possible values include: 'KubernetesCluster', 'LinuxVM'
      attr_accessor :host_platform_type
          ...
          type: {
            ...
            model_properties: {
              ...
              io_tedge_agent_info: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.ioTEdgeAgentInfo',
                type: {
                  name: 'Composite',
              ...
              host_platform_type: {
                ...
                required: false,
                read_only: true,
                serialized_name: 'properties.hostPlatformType',
                type: {
                  name: 'String'
                }
              },
